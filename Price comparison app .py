...
box1.place(relx=0.3, rely=0.4, anchor="center")
box2.place(relx=0.7, rely=0.4, anchor="center")
box3.place(relx=0.3, rely=0.7, anchor="center")
box4.place(relx=0.7, rely=0.7, anchor="center")
